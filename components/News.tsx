...
export default function News() {
    return (
        <div className="h-auto w-full items-center flex flex-col gap-4 p-2">
            {fakeNews.map((news) => (
                <Link href={`${news.link}`} className="md:w-1/2 w-full flex flex-col items-center">
                    <div className="flex h-20 w-full gap-4 border-b border-b-gray-400" key={news.headline}>
